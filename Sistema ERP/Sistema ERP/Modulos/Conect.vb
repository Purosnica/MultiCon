...
Module Conect
    ...
    'Public Sub CORREO(ByVal x As String, ByVal descripcion As String, ByVal sujeto As String, ByVal SOL As String)
    '    Dim email As New MailMessage
    '    Dim CV As String
    '    Dim correop As String = "pman_adminit@albanisa.com.ni"

    '    Dim ESOL As String = DameValorDB("select isnull(correo,'') from Tblusuarios WHERE IdUsuario=" + SOL + "")
    '    If ESOL = "" Then
    '        MsgBox("No se encontro el correo.", vbCritical)
    '        Exit Sub
    '    End If
    '    'Mantenimiento'
    '    If SOL = "396" Then
    '        email.Subject = sujeto
    '        email.From = New MailAddress(ESOL, x)
    '        email.To.Add(ESOL)
    '        CV = "mareas@albanisa.com.ni,"
    '        CV += "sotob@albanisa.com.ni,"
    '        CV += "sevillac@albanisa.com.ni,"
    '        CV += "roblesr@albanisa.com.ni"
    '        email.CC.Add(CV)
    '        email.Body = descripcion
    '        Dim smtp1 As New SmtpClient("smtp.gmail.com")
    '        smtp1.EnableSsl = True
    '        smtp1.Credentials = New System.Net.NetworkCredential("silvab@albanisa.com.ni", "Odern12345")
    '        smtp1.Port = "587"
    '        smtp1.Send(email)
    ...
    '        'Electrico'
    '    ElseIf SOL = "1221" Then
    '        email.Subject = sujeto
    '        email.From = New MailAddress(ESOL, x)
    '        email.To.Add(ESOL)
    '        CV = "tellezc@albanisa.com.ni,"
    '        CV += "sevillac@albanisa.com.ni,"
    '        CV += "roblesr@albanisa.com.ni"
    '        email.CC.Add(CV)
    '        email.Body = descripcion
    ...
    '    ElseIf SOL = "1639" Then
    '        email.Subject = sujeto
    '        email.From = New MailAddress(ESOL, x)
    '        email.To.Add(ESOL)
    '        CV = "pochetm@albanisa.com.ni,"
    '        CV += "sevillac@albanisa.com.ni,"
    '        CV += "roblesr@albanisa.com.ni"
    '        email.CC.Add(CV)
    '        email.Body = descripcion
    ...
    '    ElseIf SOL = "1301" Or SOL = "1295" Then
    '        email.Subject = sujeto
    '        email.From = New MailAddress(ESOL, x)
    '        email.To.Add(ESOL)
    '        CV = "sotob@albanisa.com.ni,"
    '        CV = "torreso@albanisa.com.ni,"
    '        CV += "areasm@albanisa.com.ni,"
    '        CV += "pochetm@albanisa.com.ni,"
    '        CV += "roblesr@albanisa.com.ni"
    '        email.CC.Add(CV)
    '        email.Body = descripcion
    '        Dim smtp1 As New SmtpClient
    '        smtp1.Host = "mail.albanisa.com.ni"
    '        smtp1.EnableSsl = True
    '        smtp1.Credentials = New System.Net.NetworkCredential("silvab@albanisa.com.ni", "Odern12345")
    '        smtp1.Port = "587"
    '        smtp1.Send(email)

    '    ElseIf ESOL = Nothing Then
    '        Exit Sub
